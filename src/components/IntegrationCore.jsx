...
import bg from '../assets/images/integrationc.png';

export default function IntegrationCore({
  ...
  return (
    <div 
      className={`flex items-center justify-center ${containerClass} py-8 relative`}
      style={{
