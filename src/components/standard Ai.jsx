    ...
    return (
        ...
        >
            <div className="flex items-center justify-center min-h-screen p-4 sm:p-6 md:p-8">
                <div className="flex flex-col lg:flex-row items-center lg:items-start justify-between max-w-6xl w-full gap-8 sm:gap-10 lg:gap-12">
                    ...
                    <div className="flex-1 flex justify-center items-center w-full">
                        <div className="relative w-full max-w-[220px] sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl">
                            ...
                            <img src={stai} alt="" className="w-full h-auto relative z-10" />
                        </div>
                    </div>
