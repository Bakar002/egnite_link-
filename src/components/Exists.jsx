    ...
    cards: [
      {
        ...
        description:
          "E-Gnite Link AI Systems™ engineers permanent growth infrastructure — powered by intelligent automation and liberated from platforms, paid traffic, and media volatility.",
      },
      {
        id: 2,
        icon: "📊",
        ...
        description:
          "Modern business infrastructure must operate autonomously — without relying on human  bandwidth, ad platforms, content cycles, or unpredictable algorithms.",
      },
    ],
  },
}) => {
            ...
            <div className="flex flex-col sm:flex-col md:flex-row lg:flex-row  sm:gap-6">
              ...
              <div className="group relative lg:ms-18 transform hover:scale-105 transition-all duration-500 
                ...
                <div className="relative bg-[radial-gradient(42.64%_44.32%_at_50%_0%,_rgba(57,143,255,0.4)_0%,_rgba(57,143,255,0)_98.07%)] backdrop-blur-lg 
                    border border-slate-700/60 rounded-2xl p-4 sm:p-6 
                    hover:bg-slate-800/80 hover:border-slate-600/80 
                  ...
                  <div className="relative z-10 flex flex-col items-center text-center space-y-4">
                    <div className="w-12 h-12 flex items-center justify-center bg-gradient-to-br from-cyan-500/30 to-blue-600/30 border border-cyan-400/40 rounded-xl group-hover:scale-110 transition-all duration-500">
                      <img src={aas} alt="" className="w-6 h-6" />
                    </div>
